...
flowers=["Alstroemeria","Calla Lily","Daisy","Gardenia","Carnation","Gerbera Daisy","Orchid","Tulip","Peony","Dahlia","Marigold","Aster","Azalea","Buttercup","Chrysanthemum","Geranium","Delphinium","Lavender","Snapdragon","Zinnia","Iris","Rose","Sunflower","Poppy","Periwinkle","Crocus","Black-eyed Susan","Daffodil",
         "Petunia","Ranunculus","Violet","Dusty Miller","Hyacinth","Begonia","Camellia","Clematis","Coneflower","Evening Primrose","Forget Me Not","Forsythia","Freesia","Gladiolus","Hellebore","Hibiscus","Hydrangea","Jasmine","Lilac","Poinsettia","Queen Anne's Lace","Rhododendron"]
...
def ribbonChoice():
    ...
    answer = input("Choose from our following options: red , white , black , blue , light-blue , green , dark-green , pink , baby-pink , purple , orange, yellow, lime-green, dark-blue, violet, cyan, light-purple, Fuschia, Brown, Silver, Gold, random:")
    if answer == "random":
        random_item = random.choice(ribbon)
        print("Your random ribbon color is..." + random_item + "! amazing color, this bouquet is done, get excited!")
    else:
...
def bouquetMaker(count):
    ...
    for i in range(count):
        ...
        if answer == "random":
            ...
            print(answer + "! amazing choice, this bouquet is looking amazing so far!")
            print("Finally, it is time to choose the color of your ribbon, you have many options here")
        ans = input("Choose from our following options: red , white , black , blue , light-blue , green , dark-green , pink , baby-pink , purple , orange, yellow, lime-green, dark-blue, violet, cyan, light-purple, Fuschia, Brown, Silver, Gold, random:")
        if ans == "random":
            random_thing = random.choice(ribbon)
            print("Your random ribbon color is..." + random_thing + "! amazing color, this bouquet is done, get excited!")
        else:
            print(ans + "! amazing choice, this bouquet is almost done, get excited!")
        if answer == "random" or ans == "random":
            print("Here is your bouquet, so stunning!" )
            print("Your bouquet can be an arrangment of these flowers: " + str(list) + " With this wrapping paper " + random_item + " and to finish it off with this " + random_thing + " ribbion." )
        else:
            print("Here is your bouquet, so stunning!" )
            print("Your bouquet can be an arrangment of these flowers: " + str(list) + " With this wrapping paper " + answer + " and to finish it off with this " + ans + " ribbion." )
bouquetMaker(1)
